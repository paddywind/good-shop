    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        ...
        <header className="text-center mb-12 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 tracking-tight mb-4">
            About The Community Blog
          </h1>
          <p className="max-w-4xl mx-auto text-base sm:text-lg md:text-xl text-gray-600">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-10 max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 sm:p-8 text-center border-t-4 border-green-600 transition hover:shadow-2xl hover:-translate-y-1 duration-300">
            <div className="text-green-600 mb-4 mx-auto">
              {/* Icon for Vision/Growth */}
              <svg className="w-8 h-8 sm:w-10 sm:h-10 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
            </div>
            <h2 className="text-xl sm:text-2xl font-bold mb-3 text-gray-900">Our Vision</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700">
          ...
          <div className="bg-white rounded-xl shadow-xl p-6 sm:p-8 text-center border-t-4 border-indigo-600 transition hover:shadow-2xl hover:-translate-y-1 duration-300">
            <div className="text-indigo-600 mb-4 mx-auto">
              {/* Icon for Values/Code Integrity */}
              <svg className="w-8 h-8 sm:w-10 sm:h-10 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg>
            </div>
            <h2 className="text-xl sm:text-2xl font-bold mb-3 text-gray-900">Our Values</h2>
            <p className="text-sm sm:text-base md:text-lg text-gray-700">
