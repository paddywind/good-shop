  ...
  return (
    <footer className="bg-gray-900 text-gray-300 border-t border-gray-800">
      <div className="w-11/12 mx-auto py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        {/* Brand */}
        <div>
          <h1 className="text-2xl font-bold text-white mb-3">Community Blog</h1>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><Link href="#" className="hover:text-blue-400 transition">Feature a Blog</Link></li>
            <li><Link href="#" className="hover:text-blue-400 transition">Promote Your Content</Link></li>
      ...
      {/* Bottom */}
      <div className="text-center py-5 border-t border-gray-800 text-gray-500 text-sm">
        © {new Date().getFullYear()} Community Blog. All rights reserved.
      </div>
    </footer>
  );
}
